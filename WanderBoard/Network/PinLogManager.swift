...
class PinLogManager {
    ...
    // Pinlog 생성
    func createPinLog(location: String, startDate: Date, endDate: Date, title: String, content: String, images: [(UIImage, Bool)], authorId: String, attendeeIds: [String], isPublic: Bool) async throws -> PinLog {
